...
//		q.setParameter(1, 8);
	...
	//璁惧畾fetch type 涓簂azy鍚庡皢涓崭细链夌浜屾浔sql璇彞
	@Test
	...
	//锷ㄦ坠娴嬭瘯left right join
	//涓轰粈涔堜笉鑳界洿鎺ュ啓Category鍚嶏紝钥屽繀椤诲啓t.category
	//锲犱负链夊彲鑳藉瓨鍦ㄥ涓垚锻桦彉閲忥纸鍚屼竴涓被锛夛紝闇€瑕佹寚鏄庣敤鍝竴涓垚锻桦彉閲忕殑杩炴帴鏉′欢鏉ュ仛杩炴帴
	@Test
	...
	public void testHQL_14() {
		Session session = sf.openSession();
		session.beginTransaction();
		Query q = session.createQuery("from Msg m where m = :MsgToSearch "); //涓嶉吨瑕?
		Msg m = new Msg();
		m.setId(1);
