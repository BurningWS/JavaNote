...
System.out.println(dirPath);
			...
			sub4.mkdirs();
			// 方法5：新建目录 "dir/sub5"。根据uri 						在windows下会报错
			...
			File l1_hide = new File("dir", ".l1_hide.txt"); // 在linux中,
															// "."开头的文件是隐藏文件。
			...
			// 方法4：新建文件 "dir/l1_uri.txt"。根据URI新建文件  			在windows下会报错
