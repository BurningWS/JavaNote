...
class DB {
	...
	static {
		map.put("1", new Book(1, "JAVA-web鏉冨▉鎸囧崡", "xx", "aa"));
		map.put("2", new Book(2, "AJAX鏉冨▉鎸囧崡", "xx", "aa"));
		map.put("3", new Book(3, "spring鏉冨▉鎸囧崡", "zz", "aa"));
		map.put("4", new Book(4, "struts鏉冨▉鎸囧崡", "yy", "aa"));
		map.put("5", new Book(5, "hibernate鏉冨▉鎸囧崡", "uuu", "aa"));
	}
